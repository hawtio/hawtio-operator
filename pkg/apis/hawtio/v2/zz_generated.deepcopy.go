...
func (in *HawtioAuth) DeepCopyInto(out *HawtioAuth) {
	*out = *in
	if in.InternalSSL != nil {
		in, out := &in.InternalSSL, &out.InternalSSL
		*out = new(bool)
		**out = **in
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HawtioClientCertificate) DeepCopyInto(out *HawtioClientCertificate) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HawtioClientCertificate.
func (in *HawtioClientCertificate) DeepCopy() *HawtioClientCertificate {
	if in == nil {
		return nil
	}
	out := new(HawtioClientCertificate)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HawtioHealthCheckPeriods) DeepCopyInto(out *HawtioHealthCheckPeriods) {
	*out = *in
	if in.OnlineReadinessPeriod != nil {
		in, out := &in.OnlineReadinessPeriod, &out.OnlineReadinessPeriod
		*out = new(int32)
		**out = **in
	}
	if in.OnlineLivenessPeriod != nil {
		in, out := &in.OnlineLivenessPeriod, &out.OnlineLivenessPeriod
		*out = new(int32)
		**out = **in
	}
	if in.GatewayReadinessPeriod != nil {
		in, out := &in.GatewayReadinessPeriod, &out.GatewayReadinessPeriod
		*out = new(int32)
		**out = **in
	}
	if in.GatewayLivenessPeriod != nil {
		in, out := &in.GatewayLivenessPeriod, &out.GatewayLivenessPeriod
		*out = new(int32)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HawtioHealthCheckPeriods.
func (in *HawtioHealthCheckPeriods) DeepCopy() *HawtioHealthCheckPeriods {
	if in == nil {
		return nil
	}
	out := new(HawtioHealthCheckPeriods)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HawtioLogging) DeepCopyInto(out *HawtioLogging) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HawtioLogging.
func (in *HawtioLogging) DeepCopy() *HawtioLogging {
	if in == nil {
		return nil
	}
	out := new(HawtioLogging)
	in.DeepCopyInto(out)
	return out
}
...
func (in *HawtioSpec) DeepCopyInto(out *HawtioSpec) {
	*out = *in
	...
	if in.ExternalRoutes != nil {
		in, out := &in.ExternalRoutes, &out.ExternalRoutes
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
