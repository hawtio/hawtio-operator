...
// Final version release using go 1.21
...
// Replace gnostic dependency pulled in by github.com/RHsyseng/operator-utils
// since later version provides aliasing support for pointing openapiv2 to its
// new location in github.com/google/gnostic-models
